...
/**
 * Jersey REST client generated for REST resource:Mesas_Atendidas_ViewFacadeREST
 * [model.mesas_atendidas_view]<br>
 * USAGE:
 * <pre>
 *        MesasJerseyClient client = new MesasJerseyClient();
 ...
 * @author SIMboxDEV8
 */
public class MesasJerseyClient {
    private WebTarget webTarget;
    private Client client;
    

    public MesasJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(MenuMain.BASE_URI).path("model.mesas_atendidas_view");
    }
