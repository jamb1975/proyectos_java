...
public class VentasTotalesJerseyClient {
    ...
    public VentasTotalesJerseyClient() {
        ...
        webTarget = client.target(MenuMain.BASE_URI).path("model.ventas_totales_diarias_view");
    }
    ...
    public <T> T findRange_XML(Class<T> responseType, String date_from, String date_to) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}/{1}", new Object[]{date_from,date_to}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }
