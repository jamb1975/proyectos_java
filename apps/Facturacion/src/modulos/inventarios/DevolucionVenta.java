 ...
 * @author karolyani
 */
public class DevolucionVenta extends Sample {
    ...
    public DevolucionVenta() throws IOException {
        m_BCanSave=true;
        ...
        L_CantidadSalida=new Label("Cantidad devuelta: ");
        ...
        //Tf_Producto.setPrefWidth(150);
          Text _tTexthebreo=new Text("  Devolución en venta  ");
