 ...
 * @author karolyani
 */
public class ModificarSalida extends Sample {
    ...
    private  Label L_CantidadSalida;
    private  TextField Tf_CantidadSalida;
    ...
    public ModificarSalida() throws IOException {
        m_BCanSave=true;
        ...
        L_CantidadSalida=new Label("Cantidad Salida: ");
        ...
        Tf_CantidadSalida=new TextField();
        ...
        //Tf_Producto.setPrefWidth(150);
          Text _tTexthebreo=new Text("  Generar Salida  ");
    ...
    gridpane.getStyleClass().add("background");
       ...
       gridpane.add(L_CantidadSalida, 0, 7);
       gridpane.add(Tf_CantidadSalida, 1, 7);
     ...
     nuevo.setOnAction(new  EventHandler<ActionEvent>() {
      ...
      Tf_CantidadSalida.setOnKeyReleased(new EventHandler<KeyEvent>() {
            @Override public void handle(KeyEvent keyEvent) {
                  
                try{
                    Float.valueOf(Tf_CantidadSalida.getText());
                    
               
                }  catch(Exception e)
                {
                    keyEvent.consume(); 
                    Tf_CantidadSalida.backward();
                    Tf_CantidadSalida.deleteNextChar();
     ...
     public void saveSalida() {
       boolean _IsGuardado=true;
        ...
        kardex.setDesc_kar(Ta_Descripcion.getText());
          if(Tf_Producto.getText().equals("") || Tf_CantidadSalida.getText().equals("") ||  Tf_NoFactura.getText().equals(""))
        {
            Tf_Producto.setStyle("-fx-background-color:#ff1600");
            Tf_NoFactura.setStyle("-fx-background-color:#ff1600");
            Tf_CantidadSalida.setStyle("-fx-background-color:#ff1600");
          ...
          else
          {
              ...
              kardex.setCantidad_salida(Float.parseFloat(Tf_CantidadSalida.getText().trim()));
              kardex.setTipo("sp");
          }
       ...
       ft.setOnFinished(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                success.setText("");
                   ...
                   Tf_CantidadSalida.setStyle(null);
                   Tf_CantidadSalida.getStyleClass().add("text-field");
...
private void findKardex()
{
   kardex= kardexJerseyClient.find_XML(Kardex.class,findProduct.getProducto().getId().toString(), "ep","1");
}
}
