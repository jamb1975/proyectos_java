 ...
 * @author karolyani
 */
public class ModificarEntrada extends Sample {
    ...
    public ModificarEntrada() throws IOException {
        m_BCanSave=true;
        ...
        L_CantidadEntrada=new Label("Cantidad Entrada: ");
        L_ValorEntrada=new Label("Valor Entrada: ");
        ...
        //Tf_Producto.setPrefWidth(150);
          Text _tTexthebreo=new Text("  Generar Entrada   ");
       ...
       gridpane.add(Tf_CantidadEntrada, 1, 7);
        gridpane.add(L_ValorEntrada, 0, 8);
       gridpane.add(Tf_ValorEntrada, 1, 8);
     ...
     nuevo.setOnAction(new  EventHandler<ActionEvent>() {
      ...
      Tf_ValorEntrada.setOnKeyReleased(new EventHandler<KeyEvent>() {
            @Override public void handle(KeyEvent keyEvent) {
                  
                try{
                    Float.valueOf(Tf_ValorEntrada.getText());
                    
               
                }  catch(Exception e)
                {
                    keyEvent.consume(); 
                    Tf_ValorEntrada.backward();
                    Tf_ValorEntrada.deleteNextChar();
     ...
     public void saveEntrada() {
       boolean _IsGuardado=true;
        ...
        kardex.setDesc_kar(Ta_Descripcion.getText());
          if(Tf_Producto.getText().equals("") || Tf_CantidadEntrada.getText().equals("") || Tf_ValorEntrada.getText().equals("")|| Tf_NoFactura.getText().equals(""))
        {
            ...
            Tf_ValorEntrada.setStyle("-fx-background-color:#ff1600");
            m_BCanSave=false;
        }
          else
          {
              ...
              kardex.setValor_entrada(BigDecimal.valueOf(Double.parseDouble(Tf_ValorEntrada.getText().trim())));
              kardex.setTipo("ep");
          }
       ...
       ft.setOnFinished(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                success.setText("");
                   ...
                   Tf_ValorEntrada.setStyle(null);
                   Tf_ValorEntrada.getStyleClass().add("text-field");
