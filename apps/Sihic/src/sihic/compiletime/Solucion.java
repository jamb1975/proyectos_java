 ...
 * compile time from the sample sources and stored in these Sample objects so we
 * don't have to calculate anything at runtime.
 */
...
//    private final String className;
    ...
    /**
     * List of conditional features the platform must support to run certain
     * samples
     */
