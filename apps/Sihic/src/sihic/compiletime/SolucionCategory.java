...
import static sihic.compiletime.CodeGenerationUtils.solucionArrayToCode;
import static sihic.compiletime.CodeGenerationUtils.stringToCode;
...
public class SolucionCategory {
    ...
    public String generateCode() {
        ...
        sb.append(stringToCode(name));
        sb.append(',');
        sb.append(solucionArrayToCode(samples));
        sb.append(',');
        sb.append(solucionArrayToCode(samplesAll));
        sb.append(',');
