...
import sihic.compiletime.Solucion.URL;
import java.util.*;
import javafx.application.ConditionalFeature;

/**
 * A utils class containing static methods that are useful when generating Java
 * code.
 */
public class CodeGenerationUtils {
    ...
    public static String generateCode(Solucion solucion) {
        ...
        sb.append(stringToCode(solucion.name));
        sb.append(',');
        sb.append(stringToCode(solucion.description));
        sb.append(',');
        sb.append(stringToCode(solucion.ensemblePath));
        sb.append(',');
        sb.append(stringToCode(solucion.baseUri));
        sb.append(',');
        sb.append(stringToCode(solucion.appClass));
        sb.append(',');
        sb.append(stringToCode(solucion.previewUrl));
        sb.append(',');
        sb.append(stringArrayToCode(solucion.resourceUrls));
        sb.append(',');
        sb.append(stringArrayToCode(solucion.apiClasspaths));
        sb.append(',');
        sb.append(urlArrayToCode(solucion.docsUrls));
        sb.append(',');
        sb.append(stringArrayToCode(solucion.relatesSamplePaths));
        sb.append(',');
        sb.append(stringToCode(solucion.mainFileUrl));
        sb.append(',');
        sb.append(playgroundPropertyArrayToCode(solucion.playgroundProperties));
        sb.append(',');
        sb.append(conditionalFeatureArrayToCode(solucion.conditionalFeatures));
        sb.append(',');
