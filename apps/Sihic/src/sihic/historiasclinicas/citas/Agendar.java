...
//*******************datos de paciente******************************
       ...
       // gp_genpersonas.add(observaciones, 3, 7);
        ...
        //*****************datos de autorización*************************
         gp_genpersonas.add(la_procedimiento, 4, 9);
         gp_genpersonas.add(sb_procedimiento, 5, 9);
                gp_genpersonas.add(hb_botones, 0, 10, 6, 1);
        ...
        sp_geneapb.getStylesheets().add(SihicApp.hojaestilos);
              gp_genpersonas.add(sp_geneapb, 2, 10, 3, 5);
        ...
        gp_genpersonas.add(sp_procedimiento, 2, 10, 3, 3);
    ...
    private void set_datos() {
       ...
       try
       {
       System.out.println("Consul->"+SihicApp.agnConsultorios.getDescripcion()+"- produc->"+SihicApp.s_kardex.getProducto().getNombre());
       }catch(Exception e)
       {
           e.printStackTrace();
       }
...
private void get_datos()
{
    //************************CAPTURA DATOS DE CITA**************************************************
     ...
     sb_agnconsultorios.setText(SihicApp.agnConsultorios.getDescripcion());
     ...
     get_datos_paciente();
      //***********************************CAPTURA DATOS DETALLES FACTURACION********************
       try{
      SihicApp.s_kardex=SihicApp.li_productosKardex.stream().filter(line->line.getProducto().getCodigo().equals(SihicApp.agnCitasTemp.getServicio().getCodigo())).collect(Collectors.toList()).get(0);
      }catch(Exception e)
      {    
       
      }
      SihicApp.s_producto=SihicApp.agnCitasTemp.getServicio();
      try{
