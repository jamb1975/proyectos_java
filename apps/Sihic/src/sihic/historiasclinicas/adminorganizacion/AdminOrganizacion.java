...
public class AdminOrganizacion extends Application {
    ...
    private static HclConsultasControllerClient hclConsultasControllerClient;
    ...
    public Parent createContent() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        stack = new StackPane();
        appClass = "sihic.historiasclinicas.adminorganizacion.FOrganizacion";
    ...
    public static void getOrganizacion() throws ParseException {
        ...
        try {
            l_genUnidadesOrganizacion = hclConsultasControllerClient.getOrganizacion(buscar.getText().trim());
