 ...
 */
public class FHclAntecedentesFarmacologicos extends Application {
    ...
    StackPane stack;
    private HclAntecedentesFarmacologicos hclAntecedentesFarmacologicos;
    private GridPane gp_hclantecedentesfarmacologicos;
    ...
    public Parent createContent() throws IOException {
        ...
        stack = new StackPane();
        hclAntecedentesFarmacologicos = new HclAntecedentesFarmacologicos();
        ...
        medicamento.getProperties().put("requerido", true);
...
// gridpane
        gp_hclantecedentesfarmacologicos = new GridPane();
        gp_hclantecedentesfarmacologicos.add(la_medicamento, 0, 0);
        gp_hclantecedentesfarmacologicos.add(medicamento, 1, 0);
        gp_hclantecedentesfarmacologicos.add(la_descripcion, 0, 1);
        gp_hclantecedentesfarmacologicos.add(descripcion, 1, 1);

        gp_hclantecedentesfarmacologicos.add(hb_botones, 0, 2, 2, 1);
        GridPane.setHalignment(hb_botones, HPos.CENTER);
        gp_hclantecedentesfarmacologicos.getStylesheets().add(SihicApp.hojaestilos);
        gp_hclantecedentesfarmacologicos.getStyleClass().add("background");
        gp_hclantecedentesfarmacologicos.setHgap(5);
        gp_hclantecedentesfarmacologicos.setVgap(5);
        hb_botones.setAlignment(Pos.CENTER);
        Gp_Message = new GridPane();
        Gp_Message = new GridPane();
        Gp_Message.setMinSize(gp_hclantecedentesfarmacologicos.getLayoutBounds().getHeight(), gp_hclantecedentesfarmacologicos.getLayoutBounds().getWidth());
        L_Message = new Label();
        ...
        stack.getChildren().addAll(gp_hclantecedentesfarmacologicos, Gp_Message);
        return stack;
    }
...
// A change listener to track the change in selected index
    ...
    public void save() throws InterruptedException {
        ...
        if (permitirproceso) {
            set_datos();
            try {
                hclHistoriaClinicasControllerClient.saveAntecedentesGFarmacologicos(hclAntecedentesFarmacologicos);
    ...
    private void set_datos() {
        ...
        hclAntecedentesFarmacologicos.setDescripcion(descripcion.getText());
        hclAntecedentesFarmacologicos.setMedicamento(medicamento.getText());
        hclAntecedentesFarmacologicos.setHclConsultas(SihicApp.hclconsultas);
    }

    public void validar_formulario() throws InterruptedException {
        permitirproceso = true;
        for (Object n : gp_hclantecedentesfarmacologicos.getChildren().toArray()) {
