...
public class UsuariosSoluciones extends Application {
    ...
    public Parent createContent() {
        ...
        Gp_UsuariosSoluci.add(new Label("Sucursal:"), 2, 5);
        Gp_UsuariosSoluci.add(LoadChoiceBoxGeneral.cb_sucursales, 3, 5);
    ...
    private void saveusuario() {
        if (Tf_Password.getText().trim().equals(Tf_Rpassword.getText().trim())) {
            ...
            usuarios.setSucursales(LoadChoiceBoxGeneral.v_sucursales.get(LoadChoiceBoxGeneral.cb_sucursales.getSelectionModel().getSelectedIndex()));
