...
public class FSoluciones extends Application {
    ...
    public void nuevo() {
        ...
        SihicApp.solucion = new Solucion();
    ...
    public void save() throws InterruptedException, ParseException {
        ...
        if (permitirproceso) {
            set_datos();
            try {
                if (SihicApp.solucion.getId() == null) {
    ...
    private void set_datos() {
        ...
        SihicApp.solucion.setSolucion(nombre.getText());
        SihicApp.solucion.setDescripcion(descripcion.getText());
        SihicApp.solucion.setNumeral(Integer.valueOf(numeral.getText().trim()));
        if (SihicApp.solucion.getId() == null) {
            SihicApp.solucion.setSolucionPadre(FAdminSoluciones.getSolucion());
        }

    }

    private void set_datos_for_update() {
        nombre.setText(SihicApp.solucion.getSolucion());
        descripcion.setText(SihicApp.solucion.getDescripcion());
        numeral.setText(String.valueOf(SihicApp.solucion.getNumeral()));
