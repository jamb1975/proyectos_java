package sihic.solucionpage;

import sihic.SihicApp;
import sihic.SolucionInfo.URL;
import sihic.util.Utils;
...
class SourceTab extends Tab {
    ...
    public SourceTab(URL sourceURL) {
        ...
        switch (ext) {
            ...
            case ".fxml":
                ...
                if (SihicApp.IS_EMBEDDED || SihicApp.IS_IOS || SihicApp.IS_ANDROID || !Platform.isSupported(ConditionalFeature.WEB)) {
    ...
    private static String convertToHTML(String source) {
        ...
        if (shCoreJs == null) {
            shCoreJs = Utils.loadFile(SihicApp.class.getResource("syntaxhighlighter/shCore.js")) + ";";
        }
        if (shBrushJScript == null) {
            shBrushJScript = Utils.loadFile(SihicApp.class.getResource("syntaxhighlighter/shBrushJava.js"));
        }
        if (shCoreDefaultCss == null) {
            shCoreDefaultCss = Utils.loadFile(SihicApp.class.getResource("syntaxhighlighter/shCoreDefault.css")).replaceAll("!important", "");
        }
