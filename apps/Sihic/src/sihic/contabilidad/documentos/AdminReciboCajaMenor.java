 ...
 * @author adminlinux
 */
public class AdminReciboCajaMenor extends Application {
    ...
    public Parent createContent() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        tp_generic.setText("Administrar Recibos de Caja Menor");
        ...
        stack = new StackPane();
        appClass = "sihic.contabilidad.documentos.FReciboCajaMenor";
        ...
        norecibo.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ReciboCaja, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ReciboCaja, String> recibocaja) {

                return new SimpleStringProperty(recibocaja.getValue().getNocomprobantecerosizquierda().toString());
        ...
        fecha.setText("Fecha");
        fecha.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ReciboCaja, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ReciboCaja, String> recibocaja) {

                return new SimpleStringProperty(sihic.util.UtilDate.formatodiamesyear(recibocaja.getValue().getFechaelaboracion()));

            }
        });

        TableColumn pagadoa = new TableColumn();
        pagadoa.setMinWidth(400);
        pagadoa.setText("Pagado a");
        pagadoa.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ReciboCaja, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ReciboCaja, String> recibo) {

                return new SimpleStringProperty(recibo.getValue().getProveedores().getNombre());

            }
        });

        TableColumn concepto = new TableColumn();
        concepto.setMinWidth(430);
        concepto.setText("Concepto");
        concepto.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ReciboCaja, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ReciboCaja, String> recibo) {

                return new SimpleStringProperty(recibo.getValue().getConcepto());
        ...
        valor.setText("Valor");
        valor.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ReciboCaja, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ReciboCaja, String> recibo) {

                return new SimpleStringProperty(recibo.getValue().getValor().toString());

            }
        });

        tv_generic.getColumns().addAll(norecibo, fecha, pagadoa, concepto, valor);
    ...
    public static void getRecords() throws ParseException {
        //colocamos los datos
        try {
            SihicApp.reciboCajaControllerClient.getRecords(dp_from.getValue().toString(), dp_to.getValue().toString(), buscar.getText());
            ol_generic.clear();
            ol_generic.addAll(SihicApp.li_recibocaja.toArray());
