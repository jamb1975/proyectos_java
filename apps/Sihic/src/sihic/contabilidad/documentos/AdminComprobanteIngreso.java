...
public class AdminComprobanteIngreso extends Application {
    ...
    public Parent createContent() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        tp_generic.setText("Administrar Comprobantes de Ingreso");
        ...
        stage.setTitle("Comprobante de Ingreso");
        ...
        TableColumn recibido = new TableColumn();
        recibido.setMinWidth(400);
        recibido.setText("Recibido");
        recibido.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ComprobanteIngreso, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ComprobanteIngreso, String> comprobanteingreso) {

                return new SimpleStringProperty(comprobanteingreso.getValue().getObservaciones());

            }
        });

        TableColumn observ = new TableColumn();
        observ.setMinWidth(400);
        ...
        observ.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ComprobanteIngreso, String>, ObservableValue<String>>() {
            ...
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ComprobanteIngreso, String> comprobanteingreso) {
                ...
                return new SimpleStringProperty(comprobanteingreso.getValue().getConcepto());
        ...
        valor.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ComprobanteIngreso, String>, ObservableValue<String>>() {
            ...
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ComprobanteIngreso, String> comprobanteingreso) {
                ...
                return new SimpleStringProperty(comprobanteingreso.getValue().getValor().toString());

            }
        });

        tv_generic.getColumns().addAll(nofactura, fecha, recibido, observ, valor);
    ...
    public static void getRecords() throws ParseException {
        ...
        try {
            ...
            ol_generic.clear();
            ol_generic.addAll(SihicApp.conComprobanteIngresoControllerClient.getListComprobantesIngresos(dp_from.getValue().toString(), dp_to.getValue().toString(), buscar.getText()).toArray());
