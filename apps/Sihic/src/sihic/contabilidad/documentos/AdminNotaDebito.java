 ...
 * @author adminlinux
 */
public class AdminNotaDebito extends Application {
    ...
    public Parent createContent() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        tp_generic.setText("Administrar Notas Débito");
        ...
        stack = new StackPane();
        appClass = "sihic.contabilidad.documentos.FNotaDebito";
        ...
        norecibo.setText("N° Nota Débito");
        norecibo.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<NotaDebito, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<NotaDebito, String> notadebito) {
        ...
        fecha.setText("Fecha");
        fecha.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<NotaDebito, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<NotaDebito, String> notadebito) {
        ...
        banco.setMinWidth(250);
        banco.setText("Banco");
        banco.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<NotaDebito, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<NotaDebito, String> notaDebito) {

                return new SimpleStringProperty(notaDebito.getValue().getBanco());

            }
        });
        TableColumn nocuenta = new TableColumn();
        nocuenta.setMinWidth(250);
        nocuenta.setText("Banco");
        nocuenta.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<NotaDebito, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<NotaDebito, String> notaDebito) {

                return new SimpleStringProperty(notaDebito.getValue().getNocuenta());

            }
        });
        TableColumn concepto = new TableColumn();
        concepto.setMinWidth(330);
        concepto.setText("Concepto");
        concepto.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<NotaDebito, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<NotaDebito, String> notaDebito) {

                return new SimpleStringProperty(notaDebito.getValue().getConcepto());
        ...
        valor.setText("Valor");
        valor.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<NotaDebito, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<NotaDebito, String> notaDebito) {

                return new SimpleStringProperty(notaDebito.getValue().getValor().toString());

            }
        });

        tv_generic.getColumns().addAll(norecibo, fecha, banco, nocuenta, concepto, valor);
    ...
    public static void getRecords() throws ParseException {
        //colocamos los datos
        try {
            SihicApp.notaDebitoControllerClient.getrecorsd(dp_from.getValue().toString(), dp_to.getValue().toString(), buscar.getText());
            ol_generic.clear();
            ol_generic.addAll(SihicApp.li_notadebito.toArray());
...
//set scene to stage
    ...
    private void checkregistroexistente() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if ((tv_generic.getSelectionModel()) != null) {
            SihicApp.notaDebito = (NotaDebito) tv_generic.getSelectionModel().getSelectedItem();
