 ...
 * @author adminlinux
 */
public class AdminMedicamentos extends Application {
    ...
    public Parent createContent() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        tp_generic.setText("Administrar Médicamentos");
        tp_generic.setCollapsible(false);
        stage.setTitle("Médicamentos");
    ...
    public static void getRecords() throws ParseException {
        ...
        try {
            ...
            ol_Productos.addAll(SihicApp.productoControllerClient.findmedicamentosall(buscar.getText()).toArray());
