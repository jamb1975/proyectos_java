 ...
 * @author adminlinux
 */
public class FBalancePrueba extends Application {
    ...
    public Parent createContent() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        tp_generic.setText("BALANCE DE PRUEBA "+sihic.util.UtilDate.obtenerMes(SihicApp.li_libromayorbalances.get(0).getAño(),SihicApp.li_libromayorbalances.get(0).getMes()).toUpperCase()+" DE "+SihicApp.li_libromayorbalances.get(0).getAño());
        tp_generic.setCollapsible(false);
        tp_generic.getStylesheets().add(SihicApp.hojaestilos);
        ...
        tv_generic.getColumns().add(column("Haber", BalancePrueba::getS_haber, false, null,150));
         ...
         new Observable[] {item.debeProperty(),item.haberProperty()});
    ...
    public static void getRecords() throws ParseException {
        try {
          ...
          //  ol_balanceprueba.addAll(SihicApp.li_balaBalancePruebas);
          System.out.println("size->"+SihicApp.li_balaBalancePruebas.size());
            for(BalancePrueba bp:SihicApp.li_balaBalancePruebas){
