 ...
 * @author adminlinux
 */
public class AdminInsumos extends Application {
    ...
    public Parent createContent() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        tp_generic.setText("Administrar Insumos Médicos");
        tp_generic.setCollapsible(false);
        stage.setTitle("Insumo Médico");
        ...
        buscar.textProperty().addListener((observable, oldValue, newValue) -> {
            try {
                ...
                Logger.getLogger(AdminInsumos.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
        ImageView imageView;
        ...
        tv_Productos.getColumns().addAll(codigo, nombre, precio, precio2016, precio2017, precio2018);
    ...
    public static void getRecords() throws ParseException {
        ...
        try {
            ...
            ol_Productos.addAll(SihicApp.productoControllerClient.findinsumosall(buscar.getText()).toArray());
