...
public class Cabecera extends PdfPageEventHelper {
    ...
    public Cabecera(Factura factura) {
        ...
        try {
            ...
            switch(factura.getPrefijo().substring(0, 1))
            {
                case "A":
                    ...
                    {
                        case "1": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006388690 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                        case "2": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006382795 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                        case "3": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006387361 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                        case "4": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006385861 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                ...
                case "P":
                    switch(SihicApp.usuarios.getSucursales().getCodigo())
                    {
                        case "1":     if(sihic.util.UtilDate.getmesfecha(factura.getFacturaDate()) <= 6 && sihic.util.UtilDate.getyearfecha(factura.getFacturaDate()) <= 2021)
                                     {
                                       tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764013340124 Fecha 18/05/2021 Facturación por Computador desde N° 5001 al 20000", fuente));
                                     }
                                     else
                                     {
                                         tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764014549494 Fecha 25/06/2021 Facturación por Computador desde N° 1 al 10000", fuente));
                                     }
                                    break;
                        case "2": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006384222 Fecha 27/10/2020 Facturación por Computador dede N° 1 al 5000", fuente));
                                  break;
                        case "3": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006387875 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                        case "4": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006386092 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                ...
                case "T":
                    switch(SihicApp.usuarios.getSucursales().getCodigo())
                    {
                        case "1":     tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006389667 Fecha 27/10/2020 Facturación por Computador dede N° 1 al 5000", fuente));
                                      break;
                        case "2": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18762010496165 Fecha 07/05/2018 Facturación por Computador desde N° 1 al 1000", fuente));
                                  break;
                        case "3": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006388192 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                        case "4": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18762010496165 Fecha 07/05/2018 Facturación por Computador desde N° 1 al 1000", fuente));
                                  break;
               ...
               case "E":
                    switch(SihicApp.usuarios.getSucursales().getCodigo())
                    {
                        case "1":     tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006389380 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                      break;
                        case "2": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006383872 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                        case "3": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006388192 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                        case "4": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764006386315 Fecha 27/10/2020 Facturación por Computador desde N° 1 al 5000", fuente));
                                  break;
                ...
                case "S":
                    switch(SihicApp.usuarios.getSucursales().getCodigo())
                    {
                        case "1": tableImagenTexto.addCell(new Paragraph("Autorización DIAN N° 18764014549494 Fecha 25/06/2021 Facturación por Computador desde la N° 1 al 10000", fuente));
                                 break;
                    }    
                break;
            }
            ...
            tableCliente.addCell(new Paragraph("Factura de venta" +     " N° " + factura.getNofacturacerosizquierda() , fuente));
            ...
            try {
                if (factura.getPrefijo().substring(0, 1).equals("A") || factura.getPrefijo().substring(0, 1).equals("P")) {
                   tableCliente.getDefaultCell().setColspan(2);
                    tableCliente.addCell(new Paragraph("Entidad: " + factura.getGenEapb().getNombre() + " Código: " + factura.getGenEapb().getCodigo() +  " Nit:"+ factura.getGenEapb().getNit()+" Ciudad: "+ SihicApp.sucursales.getNombre()+" \nObservación: Por Concepto de Prestación de Servicios de Radiología e Imágene Diagnósticas Reg. "+factura.getGenTiposUsuarios().getNombre()+" en el Mes de "+ sihic.util.UtilDate.obtenerMes(factura.getFacturaItems().get(0).getHclConsultas().getAgnCitas().getFechaHora())+" de "+sihic.util.UtilDate.getyearfecha(factura.getFacturaItems().get(0).getAgnCitas().getFechaHora()), fuente));
                    tableCliente.addCell(new Paragraph("Anexos: RIPS + SOPORTES ORIGINALES                 " + String.format("                                 Pagina %d ", writer.getPageNumber()), fuente));

                } else {
                    if (factura.getPrefijo().equals("T")) {
                        try{
                        tableCliente.addCell(new Paragraph("Entidad: " + factura.getFacturaItems().get(0).getGenPacientes().getAseguradora().getNombre() + " Código: " + factura.getFacturaItems().get(0).getGenPacientes().getAseguradora().getCodigo() + " \nServicios: Imagenes de Imagenologia", fuente));
                        tableCliente.addCell(new Paragraph("Nit: " + factura.getFacturaItems().get(0).getGenPacientes().getAseguradora().getNit() + " Anexos: RIPS + SOPORTES ORIGINALES \n" + String.format("                                 Pagina %d ", writer.getPageNumber()), fuente));
                        }catch(Exception e)
                        {
                        tableCliente.addCell(new Paragraph("Entidad: " + factura.getFacturaItems().get(0).getGenPacientes().getGenEapb().getNombre() + " Código: " + factura.getFacturaItems().get(0).getGenPacientes().getGenEapb().getCodigo() + " \nServicios: Imagenes de Imagenologia", fuente));
                        tableCliente.addCell(new Paragraph("Nit: " + factura.getFacturaItems().get(0).getGenPacientes().getGenEapb().getNit() + " Anexos: RIPS + SOPORTES ORIGINALES \n" + String.format("                                 Pagina %d ", writer.getPageNumber()), fuente));
                    
                        }
                    } else {
                        tableCliente.addCell(new Paragraph("Cliente: " + factura.getFacturaItems().get(0).getGenPacientes().getGenPersonas().getNombres() + " Nit o CC: " + factura.getGenPersonas().getDocumento() + " \nServicios: Imagenes de Imagenologia", fuente));
                        tableCliente.addCell(new Paragraph("Nit o Cc: " + factura.getFacturaItems().get(0).getGenPacientes().getGenPersonas().getDocumento() + " Anexos: RIPS + SOPORTES ORIGINALES \n" + String.format("                                 Pagina %d ", writer.getPageNumber()), fuente));
                ...
                } else 
                {
                    ...
                    tableCliente.addCell(new Paragraph("Nit o Cc: N Anexos: RIPS + SOPORTES ORIGINALES \n" + String.format("                                 Pagina %d ", writer.getPageNumber()), fuente));

                }

            }
                    tableCliente.addCell(new Paragraph("1", fuente));
                    tableCliente.addCell(new Paragraph("1",  fuente));
            ...
            tableHeader.writeSelectedRows(0, -1, 25, 792, writer.getDirectContent());
