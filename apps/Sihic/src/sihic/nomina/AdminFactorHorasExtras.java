...
public class AdminFactorHorasExtras extends Application {
    ...
    public Parent createContent() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        stack = new StackPane();
        appClass = "sihic.nomina.FFactorHorasExtras";
    ...
    public static void getRecords() throws ParseException {
        try {
            SihicApp.factorHorasExtrasControllerClient.getRecords();
            ol_generic.clear();
            ol_generic.addAll(SihicApp.li_facFactorHorasExtras);
...
//set scene to stage
    ...
    private void checkregistroexistente() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if ((tv_generic.getSelectionModel()) != null) {
            SihicApp.factorHorasExtras= (FactorHorasExtras) tv_generic.getSelectionModel().getSelectedItem();
            show();
        }
    }
