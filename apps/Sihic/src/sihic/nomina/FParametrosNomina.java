...
public class FParametrosNomina extends Application {
    ...
    private static final Label la_porc_retefuente95= new Label("% Retefuente <=95:");
    private static final TextField porc_retefuente95 = new TextField();
    private static final Label la_porc_retefuente95y150= new Label("% Retefuente >95 y <=150:");
    private static final TextField porc_retefuente95y150 = new TextField();
    private static final Label la_porc_retefuente150y360= new Label("% Retefuente >150 y <=3600:");
    private static final TextField porc_retefuente150y360 = new TextField() ;
    private static final Label la_porc_retefuentemay360= new Label("% Retefuente >360:");
    ...
    public void save() throws InterruptedException {
        ...
        if (permitirproceso) {
            try {
                set_datos();
                if (SihicApp.parametrosNomina.getId() == null) {
                    SihicApp.parametrosNominaControllerClient.create();
                } else {
                    SihicApp.parametrosNominaControllerClient.update();
                }
    ...
    private void set_datos() {
        SihicApp.parametrosNomina.setAuxiliotransporte(new BigDecimal(auxiliotransporte.getText()));
        SihicApp.parametrosNomina.setSalariominimo(new BigDecimal(salariomunimo.getText()));
        SihicApp.parametrosNomina.setPorc_pension(new BigDecimal(porc_pension.getText()));
        SihicApp.parametrosNomina.setPorc_arl(new BigDecimal(porc_arl.getText()));
        SihicApp.parametrosNomina.setPorc_cajacompfam(new BigDecimal(porc_cajacompfam.getText()));
        SihicApp.parametrosNomina.setPorc_cesantias(new BigDecimal(porc_cesantias.getText()));
        SihicApp.parametrosNomina.setPorc_fp(new BigDecimal(porc_fondopensiones.getText()));
        SihicApp.parametrosNomina.setPorc_icbf(new BigDecimal(porc_icbf.getText()));
        SihicApp.parametrosNomina.setPorc_intcesantias(new BigDecimal(porc_intcesantias.getText()));
        SihicApp.parametrosNomina.setPorc_prima(new BigDecimal(porc_prima.getText()));
        SihicApp.parametrosNomina.setPorc_retefuente95(new BigDecimal(porc_retefuente95.getText()));
        SihicApp.parametrosNomina.setPorc_retefuentemay95y150(new BigDecimal(porc_retefuente95y150.getText()));
        SihicApp.parametrosNomina.setPorc_retefuentemay150y360(new BigDecimal(porc_retefuente150y360.getText()));
        SihicApp.parametrosNomina.setPorc_retefuentemay360(new BigDecimal(porc_retefuentemay360.getText()));
        SihicApp.parametrosNomina.setPorc_salud(new BigDecimal(porc_salud.getText()));
        SihicApp.parametrosNomina.setPorc_sena(new BigDecimal(porc_sena.getText()));
        SihicApp.parametrosNomina.setPorc_solidaridad(new BigDecimal(porc_solidaridad.getText()));
        SihicApp.parametrosNomina.setPorc_vacaciones(new BigDecimal(porc_vacaciones.getText()));
        SihicApp.parametrosNomina.setPorc_salud_empleador(new BigDecimal(porc_saludempleador.getText()));
        SihicApp.parametrosNomina.setUvt(new BigDecimal(uvt.getText()));
        if(SihicApp.parametrosNomina.getId()==null)
        {
            SihicApp.parametrosNomina.setAño(sihic.util.UtilDate.getyearfecha(new Date()));
        }
...
//         backgroundThread.setDaemon(false);
    ...
    private void nuevoRecord() {
        SihicApp.parametrosNomina = null;
        SihicApp.parametrosNomina = new ParametrosNomina();
        for (Object n : gp_generic.getChildren().toArray()) {
            if (n.getClass() == TextField.class) {
                TextField general = (TextField) n;
                general.setText("");
    ...
    public void crearoeditar() {
        ...
        if (SihicApp.parametrosNomina != null) {
            if (SihicApp.parametrosNomina.getId() != null) {
                 getRecord();
            } else {
                nuevoRecord();
 ...
 {
       auxiliotransporte.setText(SihicApp.parametrosNomina.getAuxiliotransporte().toString());
       porc_fondopensiones.setText(SihicApp.parametrosNomina.getPorc_fp().toString());
       porc_arl.setText(SihicApp.parametrosNomina.getPorc_arl().toString());
       porc_cajacompfam.setText(SihicApp.parametrosNomina.getPorc_cajacompfam().toString());
       porc_cesantias.setText(SihicApp.parametrosNomina.getPorc_cesantias().toString());
       porc_pension.setText(SihicApp.parametrosNomina.getPorc_pension().toString());
       porc_icbf.setText(SihicApp.parametrosNomina.getPorc_icbf().toString());
       porc_intcesantias.setText(SihicApp.parametrosNomina.getPorc_intcesantias().toString());
       porc_prima.setText(SihicApp.parametrosNomina.getPorc_prima().toString());
       porc_retefuente95.setText(SihicApp.parametrosNomina.getPorc_retefuente95().toString());
       porc_retefuente95y150.setText(SihicApp.parametrosNomina.getPorc_retefuentemay95y150().toString());
       porc_retefuente150y360.setText(SihicApp.parametrosNomina.getPorc_retefuentemay150y360().toString());
       porc_retefuentemay360.setText(SihicApp.parametrosNomina.getPorc_retefuentemay360().toString());
       porc_salud.setText(SihicApp.parametrosNomina.getPorc_salud().toString());
       porc_sena.setText(SihicApp.parametrosNomina.getPorc_sena().toString());
       porc_solidaridad.setText(SihicApp.parametrosNomina.getPorc_solidaridad().toString());
       porc_vacaciones.setText(SihicApp.parametrosNomina.getPorc_vacaciones().toString());
       año.setText(String.valueOf(SihicApp.parametrosNomina.getAño()));
       salariomunimo.setText(String.valueOf(SihicApp.parametrosNomina.getSalariominimo()));
       porc_saludempleador.setText(SihicApp.parametrosNomina.getPorc_salud_empleador().toString());
       uvt.setText(SihicApp.parametrosNomina.getUvt().toString());
 }
}
