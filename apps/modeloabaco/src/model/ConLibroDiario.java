 ...
 */
@Entity
public class ConLibroDiario implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(generator = "SEQ_CONLIBRODIARIO_ID", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(name = "SEQ_CONLIBRODIARIO_ID", sequenceName = "SEQ_CONLIBRODIARIO_ID", allocationSize = 1, initialValue = 1)
    private Long id;
    @ManyToOne
