...
public class Producto implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "SEQ_ID_PROD")
    @Column(name = "ID")
    private Long id;
    @ManyToOne(optional = true, targetEntity = UnidadesMedida.class)
    @JoinColumn(name = "UNIDADESMEDIDA_ID")
