...
public class FCargosEntidad extends Application {
    ...
    public Parent createContent() throws IOException {
        ...
        util.ValidacionesCampo.ValidarTextField(sueldo);
    ...
    public void save() throws InterruptedException {
        ...
        if (permitirproceso) {
            try {
                set_datos();
                if (FXNomina.cargosEntidad.getId() == null) {
                    FXNomina.cargosEntidadControllerClient.create();
                } else {
                    FXNomina.cargosEntidadControllerClient.update();
                }
    ...
    private void set_datos() {
        ...
        FXNomina.cargosEntidad.setNivelcargo(nivelcargo.getSelectionModel().getSelectedIndex());
        FXNomina.cargosEntidad.setNombre(cargo.getText());
        FXNomina.cargosEntidad.setFunciones(funciones.getText());
          try {
        FXNomina.cargosEntidad.setPorc_arl(new BigDecimal(porcarl.getText()));
           } catch (Exception e) {
            FXNomina.cargosEntidad.setPorc_arl(new BigDecimal(porcarl.getText().replace(",", ".")));
        }
        try {
            FXNomina.cargosEntidad.setSueldo(new BigDecimal(sueldo.getText()));
        } catch (Exception e) {
            FXNomina.cargosEntidad.setSueldo(new BigDecimal(sueldo.getText().replace(",", ".")));
        }
 ...
 private void getdatos() {
        ...
        nivelcargo.getSelectionModel().select(FXNomina.cargosEntidad.getNivelcargo());
        cargo.setText(FXNomina.cargosEntidad.getNombre());
        funciones.setText(FXNomina.cargosEntidad.getFunciones());
        try
        {
        porcarl.setText(FXNomina.cargosEntidad.getPorc_arl().toString());
        }catch(Exception e)
        {
            
        }
        sueldo.setText(FXNomina.cargosEntidad.getSueldo().toString());
...
//         backgroundThread.setDaemon(false);
    ...
    private void nuevoRecord() {
        ...
        FXNomina.cargosEntidad = new CargosEntidad();
        for (Object n : gp_generic.getChildren().toArray()) {
            if (n.getClass() == TextField.class) {
                TextField general = (TextField) n;
                general.setText("");
    ...
    public void crearoeditar() {
        ...
        if (FXNomina.cargosEntidad != null) {
            if (FXNomina.cargosEntidad.getId() != null) {
                   getdatos();
            } else {
