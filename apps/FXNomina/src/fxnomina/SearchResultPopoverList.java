...
import control.PopoverTreeList;
import search.DocumentType;
...
public class SearchResultPopoverList extends PopoverTreeList<Object> implements Popover.Page {
    ...
    public void itemClicked(Object item) {
                   ...
                   {
                    FXNomina.s_genEapb = (GenEapb) item;
                   } 
                     if (GenMunicipios.class == item.getClass()) 
                     {
                        FXNomina.s_genMunicipios = (GenMunicipios) item;
                     }
                     if (ActividadesEconomicas.class == item.getClass()) 
                     {
                         FXNomina.s_ActividadesEconomicas = (ActividadesEconomicas) item;
                     } 
                     if (GenPersonas.class == item.getClass())
                     {
                         FXNomina.genPersonas = (GenPersonas) item;
                     }
                                                       
                     if (GenTiposDocumentos.class == item.getClass()) 
                     {
                         FXNomina.genTiposDocumentos = (GenTiposDocumentos) item;
                     }
                     if (GenSexo.class == item.getClass()) 
                     {
                      FXNomina.genSexo = (GenSexo) item;
                     }
