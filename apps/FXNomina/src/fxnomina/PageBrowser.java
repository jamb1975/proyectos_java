...
import solucionpage.SolucionPage;
import solucionpage.SourcePage;
...
public class PageBrowser extends Region {
    ...
    public void goToSolucion(SolucionInfo solucion) {
        FXNomina.nombresolucion = solucion.nameSolucion;
        System.out.println("url>7->" + "solucion://" + solucion.sofackarPath);
    ...
    public void goHome() {
        ...
        System.out.println("url>7->" + HOME_URL);
    }
