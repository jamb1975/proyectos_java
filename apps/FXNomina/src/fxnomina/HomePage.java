...
import static fxnomina.FXNomina.SHOW_HIGHLIGHTS;
...
public class HomePage extends ListView<HomePage.HomePageRow> implements Callback<ListView<HomePage.HomePageRow>, ListCell<HomePage.HomePageRow>>, ChangeListener<Number>, Page {
    ...
    @Override
    public void changed(ObservableValue<? extends Number> observableValue, Number number, Number newWidth) {
    ...
    @Override
    public ListCell<HomePageRow> call(ListView<HomePageRow> homePageRowListView) {
    ...
    private class HomeListCell extends ListCell<HomePageRow> implements Callback<Integer, Node>, Skin<HomeListCell> {
            ...
            if (item == null) {
                ...
                switch (item.rowType) {
                    ...
                    case Soluciones:
                        ...
                        box.setAlignment(Pos.CENTER);
                        box.getChildren().clear();
                             if(item.soluciones==null)
                             {
                                 item.soluciones=new SolucionInfo[0];
                             }
        ...
        // CALLBACK METHODS
        @Override
        public Node call(final Integer highlightIndex) {
    ...
    public static class HomePageRow {
        ...
        public HomePageRow(RowType rowType, String title, SolucionInfo[] soluciones, String title2) {
