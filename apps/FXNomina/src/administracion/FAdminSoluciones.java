...
// Turn on multiple-selection mode for the TreeTableView
    ...
    public Parent createContent() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        codigo.setOnEditCommit(new EventHandler<TreeTableColumn.CellEditEvent<Solucion, String>>() {
            ...
            public void handle(TreeTableColumn.CellEditEvent<Solucion, String> t) {
                ...
                FXNomina.solucion = (Solucion) t.getTreeTablePosition().getTreeItem().getValue();
                FXNomina.solucion.setNumeral(numeral);
                try {
                    modificaritem();
        ...
        nombre.setOnEditCommit(new EventHandler<TreeTableColumn.CellEditEvent<Solucion, String>>() {
            ...
            public void handle(TreeTableColumn.CellEditEvent<Solucion, String> t) {
                ...
                FXNomina.solucion = (Solucion) t.getTreeTablePosition().getTreeItem().getValue();
                FXNomina.solucion.setSolucion(nombre);
                try {
                    modificaritem();
                } catch (ParseException ex) {
                    Logger.getLogger(FAdminSoluciones.class.getName()).log(Level.SEVERE, null, ex);
        ...
        //**********Ventana Personas
        appPathSolucion = "administracion.FSoluciones";
        ...
        gpgeneric.getStylesheets().add(FXNomina.hojaestilos);
    ...
    private boolean checkregistroexistente() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if ((tsm.getSelectedItem()) != null) {
            FXNomina.solucion = (Solucion) tsm.getSelectedItem().getValue();
            return true;
        } else {
            return false;
        }
...
//set scene to stage
     ...
     private void addallsolutions() throws ParseException
    {
      ...
      for(int i=0;i<FXNomina.cb_soluciones.getItems().size();i++)
      {
          int numeral=0;
      ...
      if(FXNomina.solucion==null)
      {
        ...
        FXNomina.solucion.setNumeral(0);
        FXNomina.solucion.setSolucion(solucion);
        solucionControllerClient.create();
       
      }
       solucionpadre=FXNomina.solucion;
          FXNomina.solucion=new Solucion();
          numeral=Integer.valueOf(FXNomina.cb_soluciones.getItems().get(i).toString().substring(0, 1).trim());
        switch(numeral)
        {
            case 1:   solucion="Empresas Pymes";
            break;
            
            case 7:   solucion="Nomina";
            break;
      ...
      if(FXNomina.solucion==null)
      {
        ...
        FXNomina.solucion.setNumeral(numeral);
        FXNomina.solucion.setSolucion(solucion);
        FXNomina.solucion.setSolucionPadre(solucionpadre);
        solucionControllerClient.create();
        solucionpadre=null;
      ...
      solucionpadre=FXNomina.solucion;
       FXNomina.solucion=new Solucion();
       numeral=Integer.valueOf(FXNomina.cb_soluciones.getItems().get(i).toString().substring(0, 2).trim());
       solucion=FXNomina.cb_soluciones.getItems().get(i).toString().substring(2);
       solucionControllerClient.findsolucioncodigo(numeral);
      if(FXNomina.solucion==null)
      {
        FXNomina.solucion=new Solucion();
