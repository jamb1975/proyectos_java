 ...
 * @author adminlinux
 */
public class AdminAbonosFacturaProveedor  extends Application{
    ...
    tp_generic.setText("Administrar Abono Proveedoress");
        stage.setTitle("Abono Proveedores");
     ...
     TableColumn fecha = new TableColumn();
        ...
        fecha.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ConComprobanteEgreso, String>, ObservableValue<String>>() {
            ...
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ConComprobanteEgreso, String> abono) {
               ...
               {
                   return new SimpleStringProperty(abaco.util.UtilDate.formatodiamesyear(new Date()));
               }
            }
        });
...
public static void   getRecords() throws ParseException
{
       ...
       ol_generic.clear();
        ...
        ol_generic.addAll(AbacoApp.s_facturaproveedores.getComprobanteegresos().toArray());
...
private void checkregistroexistente() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException
{
 ...
 {
     AbacoApp.s_facturaproveedores.removeAbono(AbacoApp.conComprobanteEgreso);
     AbacoApp.s_facturaproveedores.calculateAbonos();
      AbacoApp.facturaProveedoresControllerClient.guardarFactura(AbacoApp.s_facturaproveedores);
     getRecords();
 }
     @Override
