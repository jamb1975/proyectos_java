 ...
 * @author adminlinux
 */
public class AdminNotas  extends Application{
  ...
  img=null;
    ...
    tv_generic=new TableView(); 
        ...
        nofactura.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Abono, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<Abono, String> abono) {
     ...
     TableColumn fecha = new TableColumn();
        ...
        fecha.setText("Fecha");
        fecha.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Abono, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<Abono, String> abono) {
               
                    return new SimpleStringProperty(abaco.util.UtilDate.formatodiamesyear(abono.getValue().getFecha()));
        ...
        observ.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Abono, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<Abono, String> abono) {
        ...
        valor.setText("Valor");
        valor.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Abono, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<Abono, String> abono) {
      ...
      //  gp_generico.getStyleClass().add("background");
        ...
        gp_generico.add(tv_generic, 0, 3,1,1);
...
private void checkregistroexistente() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException
{
       ...
       {
           AbacoApp.s_abono=(Abono)tv_generic.getSelectionModel().getSelectedItem();
