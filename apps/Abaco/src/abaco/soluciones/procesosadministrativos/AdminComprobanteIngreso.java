 ...
 * @author adminlinux
 */
public class AdminComprobanteIngreso  extends Application{
    ...
    tp_generic.setText("Administrar Recibos de Caja");
  ...
  img=null;
    ...
    tv_generic=new TableView(); 
        ...
        nofactura.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ConComprobanteIngreso, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ConComprobanteIngreso, String> abono) {
               try
               {
                    return new SimpleStringProperty(abono.getValue().getFactura().getNofacturacerosizquierda());
               }catch(Exception e)
               {
         ...
         norecibo.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ConComprobanteIngreso, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ConComprobanteIngreso, String> abono) {
     ...
     TableColumn fecha = new TableColumn();
        fecha.setMinWidth(130);
        fecha.setText("Fecha");
        fecha.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ConComprobanteIngreso, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ConComprobanteIngreso, String> abono) {
        ...
        noident.setMinWidth(130);
        noident.setText("N° Ident");
        noident.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ConComprobanteIngreso, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ConComprobanteIngreso, String> abono) {
               try{
                    return new SimpleStringProperty(abono.getValue().getFactura().getCustomer().getNo_ident());
               }catch(Exception e)
               {
                          return new SimpleStringProperty(abono.getValue().getUsuarioModificador());
       ...
       TableColumn cliente = new TableColumn();
        ...
        cliente.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ConComprobanteIngreso, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ConComprobanteIngreso, String> abono) {
               try
               {
                    return new SimpleStringProperty(abono.getValue().getFactura().getCustomer().getNombre());
                }catch(Exception e)
               {
        ...
        observ.setMinWidth(150);
        observ.setText("Concepto");
        observ.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ConComprobanteIngreso, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ConComprobanteIngreso, String> abono) {
        ...
        valor.setText("Valor");
        valor.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ConComprobanteIngreso, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ConComprobanteIngreso, String> abono) {
        ...
        tv_generic.getColumns().addAll(nofactura,norecibo,fecha,noident,cliente,observ,valor);
      ...
      //  gp_generico.getStylesheets().add("/abaco/SofackarStylesCommon.css");
       // gp_generico.getStyleClass().add("background");
        ...
        gp_generico.setMinSize(1000, 600);
...
public static void   getRecords() throws ParseException
{
       ...
       ol_generic.clear();
       ol_generic.addAll(AbacoApp.conComprobanteIngresoControllerClient.getRecords(dp_from.getValue().toString(),dp_to.getValue().toString(),buscar.getText()).toArray());
 ...
 private void show() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, InstantiationException, ClassNotFoundException
  {
      appClass="abaco.soluciones.procesosadministrativos.FComprobanteIngreso";
...
private void checkregistroexistente() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException
{
       ...
       {
           AbacoApp.s_conComprobanteIngreso=(ConComprobanteIngreso)tv_generic.getSelectionModel().getSelectedItem();
           AbacoApp.s_factura=AbacoApp.s_conComprobanteIngreso.getFactura();
       }
}
