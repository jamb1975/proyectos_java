 ...
 */
public class FCategoria extends Application {
     ...
     public Parent createContent() throws IOException {
      ...
      //***********************************************  
       ...
       codigo.getProperties().put("requerido", true);
        ...
        save.setTooltip(new Tooltip("Guardar Categoría"));
...
// gridpane
        ...
        gp_generic.add(new Label("Codigo: "), 0, 0);
...
private void set_datos_oranizacion()
{
        ...
        AbacoApp.s_categoria.setCodigo(codigo.getText().trim());
        AbacoApp.s_categoria.setM_NombreCat(nombre.getText());
...
{
 codigo.setText(AbacoApp.s_categoria.getCodigo());
 nombre.setText(AbacoApp.s_categoria.getM_NombreCat());
