 ...
 * @author karolyani
 */
public class Existencias2 extends Application {
   ...
   private ObservableList Ol_Inf_existencias;
    ...
    public static TextField Tf_Producto;
    private List<Kardex> li_kardex=new ArrayList<>(1);
   ...
   switch(cb_temas.getSelectionModel().getSelectedIndex())
    ...
    return cell ;
        ...
        Cantidad_saldo.setText("Cantidad");
        ...
        observaciones.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Kardex, String>, ObservableValue<String>>() {
            ...
            public ObservableValue<String> call(TableColumn.CellDataFeatures<Kardex, String> kardex) {
               try
               {
                    ...
                    return new SimpleStringProperty(String.valueOf(kardex.getValue().getProducto().getObservaciones()));
               }catch(Exception e)
               {
                 return new SimpleStringProperty("0");
   ...
   switch(cb_temas.getSelectionModel().getSelectedIndex())
    ...
    return cell ;
        ...
        Ta_Existencias.setMinHeight(80);
        Ta_Existencias.setMaxHeight(80);
        Ta_Existencias.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
        Ta_Existencias.getColumns().addAll(Nombre,Cantidad_saldo,precioventa,ubicacion,observaciones);
 ...
 private void getDatosExistencias()
 {
      ...
      li_kardex=AbacoApp.li_kardex.stream().filter(line ->line.getProducto().getCodigobarras().trim().toUpperCase().equals(Tf_Producto.getText().trim().toUpperCase()) || line.getProducto().getNombre().trim().toUpperCase().contains(Tf_Producto.getText().toUpperCase())).limit(1)	//filters the line, equals to "mkyong"
 ...
 private void getDatosExistencias2()
 {
