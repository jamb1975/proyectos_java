...
import abaco.controlador.Inf_AtencionAClientesJerseyClient;
 ...
 * @author SIMboxDEV8
 */
public class AtencionAClientes extends Application{
     ...
     private List<Inf_AtencionAClientes> Ar_AtencionAClientes;
      ...
      public Parent createContent()
     {
      ...
      gridpane=new GridPane();
       ...
       GridPane.setValignment(gridpaneRoot, VPos.TOP);
         ...
         gridpane.setMinSize(800, 550);
       gridpaneRoot.setMinSize(800, 550);
  ...
  private void  load_AtencionAClientes()
    {
        ...
        inf_AtencionAClientesJerseyClient= new Inf_AtencionAClientesJerseyClient();
          Ar_AtencionAClientes=inf_AtencionAClientesJerseyClient.findRange_XML(Dp_Date_from.getValue().toString(),Dp_Date_to.getValue().toString());
