 ...
 * @author karolyani
 */
public class DeudasProveedores extends Application {
    ...
    public Parent createContent() throws IOException {
        ...
        stageabonosgeneral.setTitle("Abono General Facturas");
         ...
         tp_generic=new TitledPane();
           tp_generic.setText("Deudas a Proveedores");
        imageView=null;
      ...
      //  gridpane.getStyleClass().add("category-page");
       ...
       TableColumn nombre = new TableColumn();
        ...
        celular.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<FacturaProveedores, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<FacturaProveedores, String> factura) {
               
                    return new SimpleStringProperty(factura.getValue().getProveedores().getCelular());
         ...
         valor_factura.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<FacturaProveedores, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<FacturaProveedores, String> factura) {
         ...
         abonos_factura.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<FacturaProveedores, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<FacturaProveedores, String> factura) {
         ...
         tiempoendias.setMinWidth(120);
         tiempoendias.setText("D/Mora");
         tiempoendias.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<FacturaProveedores, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<FacturaProveedores, String> factura) {
 ...
 {
        //colocamos los datos
     AbacoApp.li_facturasproveedores=AbacoApp.facturaProveedoresControllerClient.deudasaproveedores(Tf_cliente.getText());
       ol_generic.clear();
...
public  void exportar_excel() throws IOException, WriteException, ParseException
  {
        ...
        String rutaArchivo = System.getProperty("user.home")+"/DeudasProveedores.xls"; 
        ...
        WritableSheet hoja = libro.createSheet("Mi hoja de trabajo 1",0);
         ...
         for(FacturaProveedores factura: AbacoApp.facturaProveedoresControllerClient.deudasaproveedores(Tf_cliente.getText()))
         {
              ...
              if(f==0)
             {
               ...
               f++;
                 hoja.insertRow(f);
                 label=null;
                 label=new jxl.write.Label(0, f, factura.getNo_factura().toString());
                 hoja.addCell(label);
              
                 
                 label=null;
                 label=new jxl.write.Label(1, f, factura.getProveedores().getNo_ident());
                 hoja.addCell(label);
                 
                 label=null;
                 label=new jxl.write.Label(2, f, factura.getProveedores().getNombre());
                 hoja.addCell(label);
               ...
               number=null;
                ...
                number=null;
                 ...
                 hoja.addCell(label);
                 label=null;
                 label=new jxl.write.Label(8, f, factura.getProveedores().getCelular());
                 hoja.addCell(label);
...
//set scene to stage
 ...
 private void showAbonogeneral() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ClassNotFoundException, InstantiationException
  {  
    ...
    sceneabonosgeneral=new Scene(p_abonogenral, Color.TRANSPARENT);
    ...
    private void calcularabonogeneral() throws ParseException, InterruptedException, IOException, PrintException
    {
        ...
        for(FacturaProveedores f: AbacoApp.li_facturasproveedores)
        {
           ...
           if(saldoabonos.compareTo(BigDecimal.ZERO)==1)
           {
                   ...
                   if(valor.compareTo(saldoabonos)==0 || valor.compareTo(saldoabonos)==1)
               {
                   ...
                   AbacoApp.conComprobanteEgreso.setConComprobanteContabilidad(AbacoApp.conComprobanteContabilidad);
                   AbacoApp.conComprobanteEgreso.setConcepto("pago a Factura N° "+f.getNo_factura().toString());
                   AbacoApp.conComprobanteEgreso.setValor(saldoabonos);
                   AbacoApp.conComprobanteEgreso.setFechaelaboracion(new Date());
                   AbacoApp.conComprobanteEgreso=AbacoApp.conComprobanteEgresoControllerClient.edit(AbacoApp.conComprobanteEgreso,AbacoApp.s_facturaproveedores);
                   AddDetalle(); 
                   AbacoApp.conComprobanteContabilidad=AbacoApp.conPucControllerClient.save(AbacoApp.conComprobanteContabilidad);
                   f.addAbono(AbacoApp.conComprobanteEgreso);
                   AbacoApp.facturaProveedoresControllerClient.guardarFactura(f);
               ...
               else
               {
                   ...
                   AbacoApp.s_conComprobanteIngreso.setConcepto("pago a proveedor Factura N° "+f.getNo_factura().toString());
