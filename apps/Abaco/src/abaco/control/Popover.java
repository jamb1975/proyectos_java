...
public class Popover extends Region implements EventHandler<Event>{
    ...
    @Override protected double computeMaxWidth(double height) {
         System.out.println("doublew->"+Double.MAX_VALUE);
    ...
    @Override protected double computeMaxHeight(double width) {
        ...
        if (scene != null) {
             System.out.println("Scene->"+(scene.getHeight() - 100));
            return scene.getHeight() - 200;
        } else {
    ...
    @Override protected void layoutChildren() {
        ...
        final int width = 350; //(int)getWidth();
        final int height = 200;//(int)getHeight();
