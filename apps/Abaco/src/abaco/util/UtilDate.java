...
//Sun Jun 07 00:22:41 GMT-05:00 2020
private static SimpleDateFormat  complicado = new SimpleDateFormat(" EEE MMM dd HH:mm:ss zzX yyyy");
...
public static Date  colocarfechacomplicada(String formato) throws ParseException {
  Date fecha;
  fecha =fechahora.parse(formato);
  System.out.println("compl ="+fecha);
