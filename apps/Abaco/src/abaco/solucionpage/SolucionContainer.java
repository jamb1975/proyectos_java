 ...
 */
public class SolucionContainer extends Region {
        
    private final boolean resizable;
    private final Parent sampleNode;

    public SolucionContainer(Parent sampleNode) {
    ...
    @Override protected void layoutChildren() {
        ...
        if (resizable) {
            ...
            layoutInArea(sampleNode, 0, 0, getWidth(), getHeight(), 0, HPos.CENTER, VPos.TOP);
        }
    }
