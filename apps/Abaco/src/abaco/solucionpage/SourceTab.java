...
import abaco.SolucionInfo.URL;
import abaco.util.Utils;
import abaco.util.WebViewWrapper;
...
class SourceTab extends Tab {
    ...
    public SourceTab(URL sourceURL) {
        ...
        switch (ext) {
            ...
            case ".fxml":
                ...
                if (AbacoApp.IS_EMBEDDED || AbacoApp.IS_IOS || AbacoApp.IS_ANDROID || !Platform.isSupported(ConditionalFeature.WEB)) {
    ...
    private static String convertToHTML(String source) {
        ...
        if (shCoreJs == null) {
            shCoreJs = Utils.loadFile(AbacoApp.class.getResource("syntaxhighlighter/shCore.js")) +";";
        }
        if (shBrushJScript == null) {
            shBrushJScript = Utils.loadFile(AbacoApp.class.getResource("syntaxhighlighter/shBrushJava.js"));
        }
        if (shCoreDefaultCss == null) {
            shCoreDefaultCss = Utils.loadFile(AbacoApp.class.getResource("syntaxhighlighter/shCoreDefault.css")).replaceAll("!important","");
        }
