...
public class FCausacionNomina extends ContabilidadFXServicios {
   ...
   private GridPane gp_generico;
    ...
    private final StageGeneric stagecausacionegreso=new StageGeneric("isoftconta.servicios.pasivos.cuentasporpagar.FICI_CausacionNomina", "Causación de Nomina",true);
 ...
 ToolBar toolBar=new ToolBar( bu_nuevo);
        ...
        tp_generic.setText("Administrar Comprobantes de Causación de Nomina");
 ...
 TableColumn concepto = new TableColumn();
        concepto.setMinWidth(250);
        concepto.setText("Concepto");
        concepto.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<DocumentoSoporte, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<DocumentoSoporte, String> documentosoporte) {
        ...
        tv_generic.getColumns().addAll(fechaelab, nocomprobante,concepto, valor,cliente );
     ...
     public static void getRecords() throws ParseException {
      ...
      /*   JaviConta.task_generic = new Task<Void>() {
        ...
        JaviConta.th_generic.start();*/
            ol_generic.clear();
            ol_generic.addAll(DocumentoSoporteController.getRecords(dp_from.getValue().toString(), dp_to.getValue().toString(),EnumDocumentoSoporte.COMPROBANTECAUSACIONNOMINA17.ordinal()));
