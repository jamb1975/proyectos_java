...
public class FICI_CausacionEgreso extends Application {
     ...
     DocumentoSoporteController.findpucporcodigo(puc.getText());
      ...
      hb_tercero.getChildren().addAll(nombre,bu_tercero);
       ...
       // detalles.setMinWidth(300);
        ...
        tv_detalles.getColumns().addAll(terceros,fechaelab,codigo, ccuenta, detalles, cdebito, ccredito);
    ...
    private  void set_datos() {
      ...
      EntidadesStatic.es_documentosoporte.setTipodocsoporte(EnumDocumentoSoporte.COMPROBANTECAUSACIONEGRESO14.ordinal());
