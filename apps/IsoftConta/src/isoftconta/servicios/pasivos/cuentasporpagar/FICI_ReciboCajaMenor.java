...
public class FICI_ReciboCajaMenor extends Application {
    ...
    public Parent createContent() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException, InterruptedException {
         FICI_LibroAuxiliar.refrescardatossegunorigen=EnumDocumentoSoporte.RECIBOCAJAMENOR2.ordinal();
        new AutoCompletionTextFieldBinding<>(IsoftConta.tercero, provider);
        ...
        IsoftConta.tercero.setPromptText("Tercero");
         IsoftConta.tercero.textProperty().addListener((observable, oldValue, newValue) -> {
           try {
                    TercerosController.load_asterceros(IsoftConta.tercero.getText());
        ...
        IsoftConta.tercero.setOnAction(e->{
           
                  puc.requestFocus();
            
        });
       IsoftConta.tercero.focusedProperty().addListener(new ChangeListener<Boolean>()
      {
    @Override
    ...
    { 
       if(!newPropertyValue)
       {   
         TercerosController.findtercerospornoident(IsoftConta.tercero.getText());
    ...
    public void changed(ObservableValue<? extends Boolean> arg0, Boolean oldPropertyValue, Boolean newPropertyValue)
    {
        ...
        valor.setOnAction(e -> {
            ...
            valor.setText("0");
            puc.setText("");
             IsoftConta.tercero.requestFocus();
      ...
      hb_tercero.getChildren().addAll(IsoftConta.tercero,bu_tercero);
        ...
        tercero.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<LibroAuxiliar, String>, ObservableValue<String>>() {
            ...
            public ObservableValue<String> call(TableColumn.CellDataFeatures<LibroAuxiliar, String> detalles) {
                ...
                return new SimpleStringProperty((detalles.getValue().getTerceros()!=null?detalles.getValue().getTerceros().getNombres():""));
    ...
    private  void set_datos() {
      ...
      EntidadesStatic.es_documentosoporte.setTipodocsoporte(EnumDocumentoSoporte.RECIBOCAJAMENOR2.ordinal());
  ...
  private boolean checkregistroexistente() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
   ...
   private static void refrescarbinding()
   {
               ...
               autoCompletionBinding = TextFields.bindAutoCompletion(IsoftConta.tercero, new Callback<AutoCompletionBinding.ISuggestionRequest, Collection<String>>()
	{
		@Override
		public Collection<String> call(org.controlsfx.control.textfield.AutoCompletionBinding.ISuggestionRequest param)
		{
		    ...
		    return EntidadesStatic.possibleSuggestions;
		}
	});
