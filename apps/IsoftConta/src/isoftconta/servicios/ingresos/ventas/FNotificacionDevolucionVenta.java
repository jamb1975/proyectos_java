...
public class FNotificacionDevolucionVenta extends ContabilidadFXServicios {
   ...
   private GridPane gp_generico;
    ...
    private final StageGeneric stagecausacionegreso=new StageGeneric("isoftconta.servicios.ingresos.ventas.FICI_NotificacionDevolucionVenta", "Notificación Devolución Venta",true);
    ...
    public String getServicioNombre() {
        return "Notificación Devolución Venta";
    }
 ...
 ToolBar toolBar=new ToolBar( bu_nuevo);
        ...
        tp_generic.setText("Administrar Notificaciones de Devoluciones Ventas");
       ...
       dp_from.setOnAction(eh->{
        ...
        nocomprobante.setText("N° Consecutivo");
        ...
        nofactura.setText("N° Doc Soporte");
        nofactura.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<DocumentoSoporte, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<DocumentoSoporte, String> documentosoporte) {

                return new SimpleStringProperty(documentosoporte.getValue().getNumerodocumentosoporte());

            }
        });
        TableColumn valor = new TableColumn();
        valor.setMinWidth(150);
        valor.setText("Valor Base");
        valor.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<DocumentoSoporte, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<DocumentoSoporte, String> documentosoporte) {

                return new SimpleStringProperty(documentosoporte.getValue().getValorbase().toString());

            }
        });
        TableColumn valorneto = new TableColumn();
        valorneto.setMinWidth(150);
        valorneto.setText("Valor Neto");
        valorneto.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<DocumentoSoporte, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<DocumentoSoporte, String> documentosoporte) {

                return new SimpleStringProperty(documentosoporte.getValue().getValorneto().toString());

            }
        });
        TableColumn cliente = new TableColumn();
        cliente.setMinWidth(250);
        cliente.setText("Concepto");
        cliente.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<DocumentoSoporte, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<DocumentoSoporte, String> documentosoporte) {

                return new SimpleStringProperty(documentosoporte.getValue().getConcepto());

            }
        });

        tv_generic.getColumns().addAll(fechaelab, nocomprobante, valor, valorneto,cliente );
     ...
     public static void getRecords() throws ParseException {
      ...
      /*   JaviConta.task_generic = new Task<Void>() {
        ...
        JaviConta.th_generic.start();*/
            ol_generic.clear();
            ol_generic.addAll(DocumentoSoporteController.getRecords(dp_from.getValue().toString(), dp_to.getValue().toString(),EnumDocumentoSoporte.NOTIFICACIONDEVOLUCIONVENTA20.ordinal()));
