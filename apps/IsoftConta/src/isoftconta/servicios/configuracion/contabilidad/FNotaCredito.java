...
public class FNotaCredito extends ContabilidadFXServicios {
   ...
   private GridPane gp_generico;
    ...
    private final StageGeneric stagecausacionegreso=new StageGeneric("isoftconta.servicios.configuracion.contabilidad.FICI_NotaCredito", "Nota de Crédito",true);
 ...
 ToolBar toolBar=new ToolBar( bu_nuevo);
        ...
        tp_generic.setText("Administrar Notas de Crédito");
     ...
     public static void getRecords() throws ParseException {
      ...
      /*   JaviConta.task_generic = new Task<Void>() {
        ...
        JaviConta.th_generic.start();*/
            ol_generic.clear();
            ol_generic.addAll(DocumentoSoporteController.getRecords(dp_from.getValue().toString(), dp_to.getValue().toString(),EnumDocumentoSoporte.NOTACREDITO10.ordinal()));
