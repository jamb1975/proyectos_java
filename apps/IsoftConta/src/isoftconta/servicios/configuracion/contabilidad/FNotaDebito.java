...
public class FNotaDebito extends ContabilidadFXServicios {
   ...
   private GridPane gp_generico;
    ...
    private final StageGeneric stagecausacionegreso=new StageGeneric("isoftconta.servicios.configuracion.contabilidad.FICI_NotaDebito", "Nota Débito",true);
     ...
     public static void getRecords() throws ParseException {
      ...
      /*   JaviConta.task_generic = new Task<Void>() {
        ...
        JaviConta.th_generic.start();*/
            ol_generic.clear();
            ol_generic.addAll(DocumentoSoporteController.getRecords(dp_from.getValue().toString(), dp_to.getValue().toString(),EnumDocumentoSoporte.NOTADEBITO9.ordinal()));
