...
public class FICI_NotaDebito extends Application {
    ...
    public Parent createContent() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException, InterruptedException {
        ...
        FICI_LibroAuxiliar.refrescardatossegunorigen=EnumDocumentoSoporte.NOTADEBITO9.ordinal();
    ...
    private  void set_datos() {
      ...
      EntidadesStatic.es_documentosoporte.setTipodocsoporte(EnumDocumentoSoporte.NOTADEBITO9.ordinal());
