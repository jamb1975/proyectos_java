...
public class FICI_NotaCredito extends Application {
    ...
    public Parent createContent() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException, InterruptedException {
        ...
        FICI_LibroAuxiliar.refrescardatossegunorigen=EnumDocumentoSoporte.NOTACREDITO10.ordinal();
    ...
    private  void set_datos() {
      ...
      EntidadesStatic.es_documentosoporte.setTipodocsoporte(EnumDocumentoSoporte.NOTACREDITO10.ordinal());
