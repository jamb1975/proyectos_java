...
public class FComprobanteEgreso extends ContabilidadFXServicios {
   ...
   private GridPane gp_generico;
    ...
    private StageGeneric stagecomprobanteegresosmasivo=new StageGeneric("isoftconta.servicios.activos.efectivo.FICI_ComprobanteEgresoMasivo", "Comprobante de  Egreso Masivo",true);
 ...
 ToolBar toolBar=new ToolBar( bu_nuevo,bu_masiButton);
        ...
        tp_generic.setText("Administrar Comprobantes de Egresos");
     ...
     public static void getRecords() throws ParseException {
        ...
        JaviConta.th_generic.start();*/
          ol_generic.clear();
          ol_generic.addAll(DocumentoSoporteController.getRecords(dp_from.getValue().toString(), dp_to.getValue().toString(),EnumDocumentoSoporte.COMPROBANTEEGRESO4.ordinal()));
...
private void show2() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ClassNotFoundException, InstantiationException {
     stagecomprobanteegresosmasivo.showmodal();
    }
