...
public class FComprobanteIngreso extends ContabilidadFXServicios {
   ...
   private GridPane gp_generico;
    ...
    private StageGeneric stagecomprobanteingresomasivo=new StageGeneric("isoftconta.servicios.activos.efectivo.FICI_ComprobanteIngresoMasivo", "Comprobante de  Ingreso Masivo",true);
    ...
    public Node getPanel(Stage stage) {
        ...
        randomColor = new Color( Math.random(), Math.random(), Math.random(), 1);
          Glyph glyph_nuevo_masivo=  IsoftConta.fontAwesome.create(FontAwesome.Glyph.CART_PLUS.getChar()).sizeFactor(2).color(randomColor).useGradientEffect();
         bu_masiButton=new Button("", glyph_nuevo_masivo);
     
        bu_masiButton.setOnAction(eh->{
            try {
               show2();
            } 
            catch (Exception ex)
 ...
 ToolBar toolBar=new ToolBar( bu_nuevo,bu_masiButton);
        ...
        nofactura.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<DocumentoSoporte, String>, ObservableValue<String>>() {
            ...
            public ObservableValue<String> call(TableColumn.CellDataFeatures<DocumentoSoporte, String> documentosoporte) {
                ...
                return new SimpleStringProperty(documentosoporte.getValue().getDocumentoSoporte().getNumerodocumentosoporte());
     ...
     public static void getRecords() throws ParseException{
        ...
        JaviConta.th_generic.start();*/
          ...
          ol_generic.clear();
          ol_generic.addAll(DocumentoSoporteController.getRecords(dp_from.getValue().toString(), dp_to.getValue().toString(),EnumDocumentoSoporte.COMPROBANTEINGRESO3.ordinal()));
...
private void show2() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ClassNotFoundException, InstantiationException {
     stagecomprobanteingresomasivo.showmodal();
    }
