...
import isoftconta.servicios.activos.efectivo.FNotaContabilidad;
...
public class FICI_NotaContabilidad extends Application {
    ...
    public Parent createContent() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException, InterruptedException {
        ...
        FICI_LibroAuxiliar.refrescardatossegunorigen=EnumDocumentoSoporte.NOTACONTABILIDAD6.ordinal();
    ...
    private  void set_datos() {
      ...
      EntidadesStatic.es_documentosoporte.setTipodocsoporte(EnumDocumentoSoporte.NOTACONTABILIDAD6.ordinal());
