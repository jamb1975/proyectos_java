...
public class FNotaContabilidad extends ContabilidadFXServicios {
   ...
   private GridPane gp_generico;
    ...
    private final StageGeneric stagecausacionegreso=new StageGeneric("isoftconta.servicios.activos.efectivo.FICI_NotaContabilidad", "Nota de Contabilidad",true);
 ...
 ToolBar toolBar=new ToolBar( bu_nuevo);
        ...
        tp_generic.setText("Administrar Notas de Contabilidad");
     ...
     public static void getRecords() throws ParseException {
      ...
      /*   JaviConta.task_generic = new Task<Void>() {
        ...
        JaviConta.th_generic.start();*/
            ol_generic.clear();
            ol_generic.addAll(DocumentoSoporteController.getRecords(dp_from.getValue().toString(), dp_to.getValue().toString(),EnumDocumentoSoporte.NOTACONTABILIDAD6.ordinal()));
