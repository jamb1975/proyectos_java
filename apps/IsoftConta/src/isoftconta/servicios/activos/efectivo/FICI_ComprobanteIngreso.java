...
import static isoftconta.IsoftConta.provider;
...
import static isoftconta.servicios.activos.cuentasporcobrar.FICI_CausacionIngreso.save;
import isoftconta.servicios.configuracion.contabilidad.FICI_Terceros;
...
public class FICI_ComprobanteIngreso extends Application {

    StackPane stack;
    private static final Label la_buscarcliente = new Label("Buscar Cliente:");
    ...
    private static final TextField nombrecliente = new TextField();
    private static final DatePicker fechaelaboracion = new DatePicker(LocalDate.now());
    private static final FieldNumero fn_valorfactura=new FieldNumero();
    private static final FieldNumero fn_valorneto=new FieldNumero();
    private static final TextField fn_nofactura=new TextField();
    ...
    private static final RadioButton rb_causacioningresos=new RadioButton();
    ...
    public Parent createContent() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException, InterruptedException {
         FICI_LibroAuxiliar.refrescardatossegunorigen=EnumDocumentoSoporte.COMPROBANTEINGRESO3.ordinal();
        ...
        hb_buscarcausacion.getChildren().addAll(causacionegreso,bu_findcausacionegreso);
         ...
         rb_causacioningresos.setToggleGroup(tg_radio);
         rb_causacioningresos.setSelected(true);
        ...
        fn_valorfactura.setDisable(true);
    ...
    public void changed(ObservableValue<? extends Boolean> arg0, Boolean oldPropertyValue, Boolean newPropertyValue)
    {
     ...
     buscartercero.textProperty().addListener((observable, oldValue, newValue) -> {
           try {
                    if(rb_causacioningresos.isSelected())
                       {   
                         DocumentoSoporteController.load_asdocumentosoporte(buscartercero.getText(), EnumDocumentoSoporte.COMPROBANTECAUSACIONINGRESO15.ordinal(),EnumDocumentoSoporte.COMPROBANTEINGRESO3.ordinal());
                       ...
                       if(EntidadesStatic.li_documentosoporte.size()>0)
                     {
                         ...
                         provider.addPossibleSuggestions(EntidadesStatic.possibleSuggestions_docsoporte);
                     }  
                     }
                       }
                    else
                     if(rb_saldosiniciales.isSelected())
                     {
                             DocumentoSoporteController.load_asdocumentosoporte(buscartercero.getText(), EnumDocumentoSoporte.SALDOINICIAL19.ordinal(),EnumDocumentoSoporte.COMPROBANTEINGRESO3.ordinal());   
      ...
      buscartercero.setOnAction(e->{
            
              fn_valorneto.requestFocus();
            
        });
     
       buscartercero.focusedProperty().addListener(new ChangeListener<Boolean>()
      {
    @Override
    public void changed(ObservableValue<? extends Boolean> arg0, Boolean oldPropertyValue, Boolean newPropertyValue)
    { 
        if (!newPropertyValue)
        {
         if(rb_causacioningresos.isSelected())
         {
         DocumentoSoporteController.finddocumentosoportecausacioningreso(buscartercero.getText());
            
                setdatosdocumentosoporte();
          
        }
          else
            if(rb_saldosiniciales.isSelected())
         {
          DocumentoSoporteController.findlibroauxiliarportecausacionnomina(buscartercero.getText());
 ...
 ImpresionDocumentoSoporte.fpdfdocumentosoportecontercero();
      ...
      hb_tercero.getChildren().addAll(nombrecliente,bu_tercero);
       ...
       // detalles.setMinWidth(300);
        ...
        tv_detalles.getColumns().addAll(ctercero,codigo, ccuenta, detalles, cdebito, ccredito);
        ...
        Gp_Generic.add(noconsecutivo, 3, 2, 1, 1);
        ...
        Gp_Generic.add(concepto, 1, 3, 1, 1);
    ...
    public void nuevo() throws ParseException, InterruptedException {
        ...
        EntidadesStatic.es_documentosoporte_root = null;
        EntidadesStatic.es_documentosoporte_root  = new DocumentoSoporte();
        gettotales();
        concepto.setText("");
        ...
        fn_valorfactura.setText("0");
        fn_valorneto.setText("0");
        noconsecutivo.setText("");
        nombrecliente.setText("0");
    }
    ...
    public void save() throws InterruptedException, ParseException {
                ...
                FComprobanteIngreso.getRecords();
    ...
    private  void set_datos() {
      ...
      EntidadesStatic.es_documentosoporte.setTipodocsoporte(EnumDocumentoSoporte.COMPROBANTEINGRESO3.ordinal());
     }
  ...
  private boolean checkregistroexistente() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
   ...
   private void setdatosdocumentosoporte() 
   {
       ...
       {
           if(EntidadesStatic.es_documentosoporte_root.getId()!=null)
           {        
       EntidadesStatic.es_terceros=EntidadesStatic.es_documentosoporte_root.getClientes();
         if(EntidadesStatic.es_terceros!=null)
         {
           nombrecliente.setText(EntidadesStatic.es_terceros.getNo_ident()+" "+EntidadesStatic.es_terceros.getNombres());
               concepto.setText(EntidadesStatic.es_documentosoporte_root.getNofacturacerosizquierda()+ " de "+EntidadesStatic.es_terceros.getNombres());
    
         }
          prefijo.setText(EntidadesStatic.es_documentosoporte_root.getPrefijo());
          fn_nofactura.setText(EntidadesStatic.es_documentosoporte_root.getNo_factura()!=null?EntidadesStatic.es_documentosoporte_root.getNo_factura().toString():"");
          fn_valorfactura.setText(EntidadesStatic.es_documentosoporte_root.getValorbase().toString());
          fn_valorneto.setText(EntidadesStatic.es_documentosoporte_root.getValorbase().toString());
          buscartercero.setText("-");
           provider.clearSuggestions();
           }
        }
 ...
 public  void getRecordingresos() throws ParseException{
