...
public class SearchResultPopoverList extends PopoverTreeList<Object> implements Popover.Page {
    ...
    public void itemClicked(Object item) {
         System.out.println("Código->"+((Puc)item).getCodigo());
        if (Puc.class == item.getClass()) {
            EntidadesStatic.es_puc = ((Puc) item);
        } 
        else
            if (Terceros.class == item.getClass()) {
            EntidadesStatic.es_terceros = ((Terceros) item);
        }
         else
            if (GenMunicipios.class == item.getClass()) {
            EntidadesStatic.es_ciudades = ((GenMunicipios) item);
        }
        popover.hide();
            ...
            if (result == null) { // empty item
                ...
                if (Puc.class == result.getClass()) {
                    title.setText(((Puc) result).getCodigo() + " " + ((Puc) result).getNombre());
                     details.setText(((Puc) result).getCodigo() + " " + ((Puc) result).getNombre());
                   
                }
                else
                    if (Terceros.class == result.getClass()) {
                    title.setText(((Terceros) result).getNo_ident() + " " + ((Terceros) result).getNombres());
                   
                }
                else
                    if (GenMunicipios.class == result.getClass()) {
                    title.setText(((GenMunicipios) result).getCodigo()+ " " + ((GenMunicipios) result).getNombre());
