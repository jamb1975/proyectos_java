...
public class NumeroDigital extends Parent {
    ...
    public NumeroDigital(Color onColor, Color offColor,String numero) {
        ...
        getChildren().clear();
        Glow onEffect = new Glow(0.7f);
        onEffect.setInput(new InnerShadow());
        // create effect for on dot LEDs
        Glow onDotEffect = new Glow(0.7f);
        
           // onDotEffect.setInput(new InnerShadow(1, Color.BLACK)); 
        
           onDotEffect.setInput(new InnerShadow(1, Color.TRANSPARENT)); 
