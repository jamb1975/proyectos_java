     ...
     function ControllerViewModel() {
      ...
      self.mdScreen = ResponsiveKnockoutUtils.createMediaQueryObservable(mdQuery);
       ...
       self.router.configure({
         'dashboard': {label: 'Recargas', isDefault: true},
         'incidents': {label: 'QR Activos'},
         'customers': {label: 'Historial Recargas'},
         'about': {label: 'About'}
       });
      ...
      // Navigation setup
      var navData = [
      {name: 'Recargas', id: 'dashboard',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-chart-icon-24'},
      {name: 'QR Activos', id: 'incidents',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-fire-icon-24'},
      {name: 'Historial Recargas', id: 'customers',
