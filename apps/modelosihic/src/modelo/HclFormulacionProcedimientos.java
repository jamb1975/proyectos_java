 ...
 */
@Entity
@Table(name = "HclFormulacionProcedimientos")
public class HclFormulacionProcedimientos implements Serializable {
    private static final long serialVersionUID = 1L;
   @Column(name = "ID", table = "HclFormulacionProcedimientos", unique = false, updatable = true, insertable = true, nullable = false, length = 255, scale = 0, precision = 22)
    @Id
    @GeneratedValue(generator = "SEQ_HCLFORMULACIONPROCEDIMIENTOS_ID", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(name = "SEQ_HCLFORMULACIONPROCEDIMIENTOS_ID", sequenceName = "SEQ_HCLFORMULACIONPROCEDIMIENTOS_ID", allocationSize = 1, initialValue = 1)
    private Long id;
