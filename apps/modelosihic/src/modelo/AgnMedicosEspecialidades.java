 ...
 */
@Entity
@Table(name = "AgnMedicosEspecialidades")
public class AgnMedicosEspecialidades implements Serializable {
  @Column(name = "ID", table = "AgnMedicosEspecialidades", unique = false, updatable = true, insertable = true, nullable = false, length = 255, scale = 0, precision = 22)
  @Id
  @GeneratedValue(generator = "SEQ_AGNMEDICOSESPECIALIDADES_ID", strategy = GenerationType.SEQUENCE)
  @SequenceGenerator(name = "SEQ_AGNMEDICOSESPECIALIDADES_ID", sequenceName = "SEQ_AGNMEDICOSESPECIALIDADES_ID", allocationSize = 1, initialValue = 1)
  private  Long id;
