 ...
 */
@Entity
@Table(name = "HclTiposAntecedentesPatologicos")
public class HclTiposAntecedentesPatologicos implements Serializable {
    private static final long serialVersionUID = 1L;
    @Column(name = "ID", table = "HclTiposAntecedentesPatologicos")
    @Id
